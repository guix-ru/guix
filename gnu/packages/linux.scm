...
(define-public linux-libre-6.18-version "6.18.44")
...
(define-public linux-libre-6.18-pristine-source
  (let ((version linux-libre-6.18-version)
        (hash (base32 "0hqd4izrmabjcp22z7h8zrxxp1r2azz78la0j0nfha38y0wdjwhg")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-6.18)))

(define-public linux-libre-6.12-version "6.12.103")
...
(define-public linux-libre-6.12-pristine-source
  (let ((version linux-libre-6.12-version)
        (hash (base32 "0xiizhw3kk2ggx9yymzmpj0q9ckday1492vqdrhsayw7x2nslhzi")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-6.12)))
...
(define-public linux-libre-6.1-version "6.1.180")
...
(define-public linux-libre-6.1-pristine-source
  (let ((version linux-libre-6.1-version)
        (hash (base32 "0spql1ybfr879wl35rfd2nwlzirvp5chi6gl1d6zqp5mb4bn03jg")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-6.1)))
