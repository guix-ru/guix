...
(define-public linux-libre-6.11-version "6.11")
...
(define deblob-scripts-6.11
  (linux-libre-deblob-scripts
   ...
   (base32 "11bjhqxwx1slh3ziaczdwmjhiycji1mvv8yd6npzhl1i5gxbsjvd")))
(define-public linux-libre-6.11-pristine-source
  (let ((version linux-libre-6.11-version)
        (hash (base32 "0bnbvadm4wvnwzcq319gsgl03ijvvljn7mj8qw87ihpb4p0cdljm")))
