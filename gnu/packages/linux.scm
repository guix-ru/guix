...
(define-public linux-libre-7.1-version "7.1.5")
...
(define-public linux-libre-7.1-pristine-source
  (let ((version linux-libre-7.1-version)
        (hash (base32 "1rs162gcf6hsafrrmp3y8k9myn20s3s62xdp4zf39pxw7imik812")))
...
(define-public linux-libre-6.18-version "6.18.41")
...
(define-public linux-libre-6.18-pristine-source
  (let ((version linux-libre-6.18-version)
        (hash (base32 "1skk2aimvhhymsvs15p83v2mwnlwbmghh82x79isia6lz3q75z0p")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-6.18)))
...
(define-public linux-libre-6.12-version "6.12.100")
...
(define-public linux-libre-6.12-pristine-source
  (let ((version linux-libre-6.12-version)
        (hash (base32 "147fvkpsa9n5gv207xyb6if0vmahmvpvrb2bfy32wj866i9p7yb7")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-6.12)))

(define-public linux-libre-6.6-version "6.6.147")
...
(define-public linux-libre-6.6-pristine-source
  (let ((version linux-libre-6.6-version)
        (hash (base32 "1fsavd2armiwrnz0w556dmm54z76zwy2as0qbbaq6s04xsvjjqz7")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-6.6)))
