...
(define-public linux-libre-7.2-version "7.2.4")
...
(define-public linux-libre-7.2-pristine-source
  (let ((version linux-libre-7.2-version)
        (hash (base32 "1p98bi0zzk3al2d0i28ms4h8vq2ps3n2prdsy69c9nip2zh0ww81")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-7.2)))

(define-public linux-libre-7.1-version "7.1.13")
...
(define-public linux-libre-7.1-pristine-source
  (let ((version linux-libre-7.1-version)
        (hash (base32 "1mqshj3ldn0md1c0am35skznnq5vmz3fvrr0cqmwwp6bzpx9akb1")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-7.1)))
...
(define-public linux-libre-6.18-version "6.18.49")
...
(define-public linux-libre-6.18-pristine-source
  (let ((version linux-libre-6.18-version)
        (hash (base32 "14c1l9hbqcjlzfl7bssa43yqsg26sycp5plx4wfnzshz24rnz0mf")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-6.18)))

(define-public linux-libre-6.12-version "6.12.108")
...
(define-public linux-libre-6.12-pristine-source
  (let ((version linux-libre-6.12-version)
        (hash (base32 "1bxsykj1w8slrn837z05ax8r9d5kkgk5kbjzbngmrm921lhfmlg1")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-6.12)))

(define-public linux-libre-6.6-version "6.6.156")
...
(define-public linux-libre-6.6-pristine-source
  (let ((version linux-libre-6.6-version)
        (hash (base32 "07a1dyaxmcv289r0n4agna2li2rfsjdld8279cs18jmg9r52dqmf")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-6.6)))
...
(define-public linux-libre-5.15-version "5.15.220")
...
(define-public linux-libre-7.2-source
  (source-with-patches linux-libre-7.2-pristine-source
                       (append
...
(define-public linux-libre-headers-7.2
  (make-linux-libre-headers* linux-libre-7.2-version
                             linux-libre-7.2-gnu-revision
                             linux-libre-7.2-source))
...
CONFIGURATION-FILE or generated by DEFCONFIG.  It must be an alist where each element has the form:
(KERNEL-OPTION . VALUE)
...
(define (mnt-reform-kernel-options version)
  `(("CONFIG_DRM_LVDS_CODEC" . m)
    ...
    ,@(if (version>=? version "7.1")
          '( ;; QCOM cpu module
            ("CONFIG_INTERCONNECT_QCOM_SM8550" . #true)
            ("CONFIG_PINCTRL_SM8550" . #true)
            ("CONFIG_PINCTRL_SM8550_LPASS_LPI" . #true)
            ("CONFIG_SM_CAMCC_8550" . #true)
            ("CONFIG_SM_GCC_8550" . #true)
            ("CONFIG_SM_GPUCC_8550" . #true)
            ("CONFIG_SM_TCSRCC_8550" . #true)
            ("CONFIG_SM_VIDEOCC_8550" . #true)
            ("CONFIG_SM_DISPCC_8550" . #true)
            ("CONFIG_USB_QCOM_EUD" . #true)
            ("CONFIG_SPMI_PMIC_CLKDIV" . #true)
...
(define-public linux-libre-arm64-mnt-reform-7.1
  ...
  (let ((base (make-linux-libre* linux-libre-7.1-version
                                 linux-libre-7.1-gnu-revision
                                 linux-libre-7.1-source
                                 '("aarch64-linux")
                ...
                (lambda* (#:key inputs #:allow-other-keys)
                  (for-each (lambda (patch)
                            ...
                            (list
                             ...
                             "qcom-mnt-reform2/3001-casey-aux-bridge-defer.patch"
                             "qcom-mnt-reform2/3003-casey-lpass-sc7280-audio-hacks.patch"
                             "qcom-mnt-reform2/4000-qcom-pci-d3cold.patch"
                             "qcom-mnt-reform2/4001-qcom-pci-d3cold-2.patch"
                             ...
                             "rk3588-mnt-reform2/0092-drm-rockchip-dw_hdmi_qp-Restrict-HPD-event-to-the-af.patch"
                             "rk3588-mnt-reform2/0094-drm-bridge-connector-Use-cached-connector-status-in-.patch"
                             "rk3588-mnt-reform2/0095-drm-bridge-Add-detect_ctx-hook-and-drm_bridge_detect.patch"
                             "rk3588-mnt-reform2/0096-drm-bridge-connector-Switch-to-.detect_ctx-for-conne.patch"
                             "rk3588-mnt-reform2/0097-drm-bridge-dw-hdmi-qp-Add-HDMI-2.0-SCDC-scrambling-a.patch"
                ...
                (lambda* (#:key inputs #:allow-other-keys)
                  (for-each (lambda (dts)
                            ...
                            (list
                             ...
                             "rockchip/rk3588-mnt-station.dts"
                             ...
                             "qcom/qcs6490-mnt-quasar.dtsi"
                             "qcom/qcs6490-mnt-reform2.dts"
                             "qcom/qcs6490-mnt-pocket-reform.dts"
                             "qcom/qcs6490-mnt-reform-next.dts"
                             "qcom/qcs8550-mnt-reform2.dts"
                             "qcom/qcs8550-mnt-pocket-reform.dts"
                             "qcom/qcs8550-mnt-reform-next.dts"))))
...
dtb-$(CONFIG_ARCH_MXC) += imx8mq-mnt-reform2-hdmi.dtb"))
                  (substitute* "arch/arm64/boot/dts/rockchip/Makefile"
                    (("rk3588-mnt-reform2.dtb")
                     "rk3588-mnt-reform2.dtb
dtb-$(CONFIG_ARCH_ROCKCHIP) += rk3588-mnt-station.dts
...
dtb-$(CONFIG_ARCH_ROCKCHIP) += rk3588-mnt-pocket-reform.dtb"))
                  (substitute* "arch/arm64/boot/dts/qcom/Makefile"
  ...
  (package
    ...
    (source (origin
              ...
              (uri (git-reference
                    ...
                    (commit (string-append "v" version))))
              (sha256
               (base32 "05h1kjs8lgdmfsdz5vcfl470zhw7j36jp7a9wip20ibb6g3s9r1k"))
              (file-name (git-file-name name version))))
    (build-system meson-build-system)
  ...
  (package
    ...
    (source (origin
              ...
              (uri (git-reference
                    ...
                    (commit (string-append "v" version))))
              (sha256
               (base32 "1877fvhd4573900zwk7y2mk2vvmgnws2wa37sv176ikxj647jvw1"))
              (file-name (git-file-name name version))))
    (build-system meson-build-system)
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32
         "1r1ysy8xpdz2nqs0svk4772fbykqh414mqivwylbj5r9v1nf8r02"))))
    (build-system gnu-build-system)
    (arguments
     (list
...
(define-public tp-smapi-module
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1q67dk0sa9k0b3ns0s42fbm7ali5018q3hqn81ldspcl0lv867xc"))))
    (build-system linux-module-build-system)
    (arguments
