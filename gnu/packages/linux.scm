...
(define-public linux-libre-7.1-version "7.1.1")
...
(define-public linux-libre-7.1-pristine-source
  (let ((version linux-libre-7.1-version)
        (hash (base32 "0z8x6wafxzc5vkim9jh8wpycdkk9y5bpxgsirmdpyznw84szl5aj")))
...
(define-public linux-libre-6.18-version "6.18.37")
...
(define-public linux-libre-6.18-pristine-source
  (let ((version linux-libre-6.18-version)
        (hash (base32 "0maj2ap1m09bxl6a3g9wc65h9sdr6y8rwc5qcqlbavb4wq0d4g58")))
   (make-linux-libre-source version
                            (%upstream-linux-source version hash)
                            deblob-scripts-6.18)))
