...
(define-public libplasma
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1vh6a2kc6r5qv1as2q1ziknvdms43gc0j39n6p0bw9hwdxxg7s8y"))))
...
(define-public aurorae
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0xmixzg6psjhzbgncgdklq9lfdivyxvfcizwgmgbwdl089x0ikzv"))))
    (build-system qt-build-system)
    (arguments
     (list #:qtbase qtbase
           #:tests? #f))
...
(define-public breeze
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1lf3fs04w8nn8niym94bid6m878j818ymy35zy1af315zzlb4l1b"))))
    (build-system qt-build-system)
...
(define-public calindori
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1dcv7xbw92byalgpg0xh6p9cavrf9qswlbgf3g6106i1gmcia1w6"))))
    (build-system qt-build-system)
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1f8ih3kwby1s2mjxr2bbsarjxa415ar88i18xmn7mrqi2rgmpcqd"))))
    (build-system qt-build-system)
    (arguments
     (list #:qtbase qtbase))
    (native-inputs
...
(define-public kactivitymanagerd
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0j3k97r9m20hwcw6b5pvrnj6d61mni5k9d7ih9af16khhjqcpdi5"))))
    (build-system qt-build-system)
    (arguments (list #:qtbase qtbase
                     #:tests? #f))
...
(define-public krdp
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "129h0lcpvfw5fcrdv4ss2dd29x7d007s34s6sv8ckxp2zx3yw9sl"))))
    (build-system qt-build-system)
    (arguments (list #:qtbase qtbase
                     #:tests? #f
                     #:phases
...
(define-public kde-gtk-config
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1a14xnniyakaz828m70j4mdh2i3sg9c8a6vb244xn6k98xn4jirp"))))
    (build-system qt-build-system)
    (arguments
     (list
      #:qtbase qtbase
...
(define-public kdecoration
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1xqfl85b269krh45nm4a9lxzmj9pv0c4r5ciiyprc2avfd9d7308"))))
    (build-system qt-build-system)
    (arguments (list #:qtbase qtbase))
    (native-inputs
...
(define-public kde-cli-tools
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1dpg17k96b71dypqqlj7r6dx5k0fjf0sislhvr1ciklw88sl7zl8"))))
    (build-system qt-build-system)
    (arguments
     (list #:qtbase qtbase
...
(define-public kdeplasma-addons
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0vs1idax8pzhlabrd0vi4gf38mzdkbc2dyqmnkvn7ww1lrln8415"))))
    (build-system qt-build-system)
    (arguments
     (list #:qtbase qtbase
...
(define-public kglobalacceld
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1ljqv2fvgrk27bpa8v1dwnfjch6kkzjh7z30lvim99bgdc0va1hn"))))
    (build-system qt-build-system)
    (arguments (list #:qtbase qtbase
                     #:phases
                     #~(modify-phases %standard-phases
...
(define-public kinfocenter
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1jikik312r1xhakz6yhgkjgizd1wn1wss5yd0p1bw5c3mjgncm58"))))
    (build-system qt-build-system)
    (arguments
     (list
      #:qtbase qtbase
...
(define-public kmenuedit
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1acn325b8srawk8h1r7diiil46l8lvcdg73wjlvz4mhy4fs7czg5"))))
    (build-system qt-build-system)
    (arguments (list #:qtbase qtbase
                     #:tests? #f))
    (native-inputs (list extra-cmake-modules kdoctools))
...
(define-public knighttime
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1ixh0wn4722pvl0mmgcrxk4s10nsqmw5hy4pbryl7kfvx97vyyyz"))))
    (build-system qt-build-system)
    (arguments (list #:qtbase qtbase))
...
(define-public kscreen
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "09b6byzwlaj1sh69dpafjhl1kv6ccg8b8ka8wh6bv22n6lapzwm1"))))
    (build-system cmake-build-system)
    (arguments
     ;; TODO: All tests fail
     (list #:tests? #f))
...
(define-public layer-shell-qt
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "02m8x9arnx194lz8fml2qc08i2lz8jjvcmhn3449xlpw7wjxp5dv"))))
    (build-system qt-build-system)
    (arguments
     (list #:qtbase qtbase
           #:tests? #f))
    ...
    (source
     (origin
       ...
       (uri (string-append "mirror://kde/stable/plasma/" version "/"
                           name "-" version ".tar.xz"))
       (sha256
        (base32 "153gajph4hz7i2wsgx9qvxij5hwyffkh17x816ikw38xq3x899lq"))))
    (build-system qt-build-system)
    (arguments
     (list
      #:qtbase qtbase
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "13jhl06msgwpvqbvgq58rc73z8n6xmrkvkwswwmglakj4jz71wvl"))))
    (native-inputs
...
(define-public kwallet-pam
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1pvxq9j0wzrg0jlv8qh42wizdp7qrcs4rcjb2dvwx8pfdpiy1nb6"))))
    (build-system qt-build-system)
    (arguments
     (list
      #:qtbase qtbase
...
(define-public milou
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1xxm84a6ipv60nqfyl2kyh8k8xaxsf7rjjrzpdza8998xa0r6mnx"))))
    (build-system qt-build-system)
    (native-inputs (list extra-cmake-modules))
    (inputs (list kcoreaddons
                  ki18n
...
(define-public oxygen-sounds
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1669z65ic40mhbniam626x5bsfvz2m5clds9rrmd39bhicbpyn09"))))
    (build-system cmake-build-system)
...
(define-public xdg-desktop-portal-kde
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0ssi2bml9c2wvzyvl2njh20dl96khpxra0512nq0x41pn86z5cq0"))))
    (build-system qt-build-system)
    (arguments (list
...
(define-public plasma-activities
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0f85wnmr9ab3qwzd42lw67s38mj9dxcsqksna84f6g1s5ypz68ly"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
...
(define-public plasma-activities-stats
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1jmwvylayhxll50apmkikgq2w5rqlnzb9k6f3ys0xfzl60x644nz"))))
    (build-system cmake-build-system)
    (arguments (list #:tests? #f))
    (native-inputs
     (list extra-cmake-modules))
...
(define-public plasma5support
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0n6jqdmc4y5367pdl2vddvypqhvyw80cwxi8cjh70vpfkqnvdpmd"))))
    (build-system qt-build-system)
    (arguments (list #:qtbase qtbase
                     #:tests? #f)) ;no tests
    (native-inputs (list extra-cmake-modules pkg-config))
...
(define-public plasma-browser-integration
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1c6yjv8rcp1rh67nllkcmz0shx0mp9sb0hcy72qbyvphzx6xjl1s"))))
    (build-system qt-build-system)
    (native-inputs (list extra-cmake-modules pkg-config))
...
(define-public plasma-desktop
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "034c9fccsqfv4p4z5q8g4fidbw7j9d5611hw03qlldzsmm0ii3g0"))))
    (build-system qt-build-system)
    (native-inputs (list extra-cmake-modules
                         dbus
                         kdoctools
...
(define-public plasma-disks
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "06vi9i9jrwgb3n8jimda4jn1bvl6cn3zl5xvcy4bvw03kijyi1pc"))))
    (build-system qt-build-system)
    (arguments (list
                #:qtbase qtbase
                #:phases
...
(define-public plasma-firewall
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "04128i1502ayk82cylyv6lndkabylj6yaps8d7q6n6zkxzjf8grc"))))
    (build-system qt-build-system)
    (arguments (list #:qtbase qtbase))
    (native-inputs (list extra-cmake-modules))
    (inputs (list iproute
...
(define-public plasma-integration
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "08symahf9657czp92mcqdghfvy2khxrk8gxf79rm524s7w3w3r21"))))
    (build-system qt-build-system)
    (arguments
     (list #:qtbase qtbase
           #:configure-flags #~(list "-DBUILD_QT5=OFF")
...
(define-public plasma-nano
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0qyh9s2i5ny830jcgllnnmdzivx9734klmr4zigkvnyb1xn1vql0"))))
    (build-system cmake-build-system)
    (native-inputs (list extra-cmake-modules pkg-config qttools))
    (inputs (list qtbase
                  qtdeclarative
...
(define-public plasma-nm
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1by8b444saky3kj6x017xra58iynhcwl79d6zbx8xbl1x65wd155"))))
    (build-system qt-build-system)
    (arguments
     (list #:qtbase qtbase))
    (native-inputs (list extra-cmake-modules pkg-config))
...
(define-public plasma-mobile
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "021ypn3my87splap3z3vn32h7c4p18xpnbmpwiqykgdsk0wqcnpx"))))
    (build-system cmake-build-system)
...
(define-public plasma-vault
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1imhr8ajh5h4amh548mfy4ming98ppb722l18ash1kkywadqrn7c"))))
    (build-system qt-build-system)
    (native-inputs (list extra-cmake-modules pkg-config))
    (inputs (list kio
                  ki18n
...
(define-public plasma-systemmonitor
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0rw31r0g44dlchqr4xa9l38pd0hqfm8hyvijj3p02cf26kr8crdq"))))
    (build-system qt-build-system)
    (native-inputs (list extra-cmake-modules))
    (inputs (list ki18n
                  kconfig
...
(define-public plasma-workspace
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "07klrqxzj494vcn8wcx64fjffzyn5skxrl5fzs1f6zpnf0fnfjs9"))))
    (build-system qt-build-system)
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "12v6cj25w154ny5g412jvjnkp4661zjc9vnis8vcwzrjn5b2axl7"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
...
(define-public powerdevil
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "06iy0dc6rfvk9hf7vzwikysy6dmckfgl2n5382xk06bbayvjgr4r"))))
    (build-system qt-build-system)
    (native-inputs (list extra-cmake-modules qttools pkg-config))
...
(define-public system-settings
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "00rqc0h50bliikhid9fliganixrg32d9mx8sjqrl8pqh4v4gd3kr"))))
    (build-system qt-build-system)
    (native-inputs (list extra-cmake-modules))
...
(define-public wacomtablet
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1gm616mijj1barajg390vfbxhrx2qgmav21000jcd803gimzy9sf"))))
    (build-system qt-build-system)
    (arguments
     (list #:qtbase qtbase
           #:test-exclude
