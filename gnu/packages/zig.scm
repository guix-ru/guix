...
(define zig-0.15.0-1459
  (let ((commit "9082b004b68b0cc0afe6e24b9277b900362c560d")
        (revision "1459")
        (base zig-0.15.0-1447))
    (package
      (inherit base)
      (name "zig")
      (version (git-version "0.15.0" revision commit))
      (source (zig-source
               version commit
               "0540356f85kdwmkmkr40680cbdyp2v8vn2r4k5n20cap74bq73s0"))
      ;; zig1
      (arguments (package-arguments zig-0.10.0-747))
      (native-inputs
       (modify-inputs native-inputs
...
(define zig-0.15.0-2738
  (let ((commit "cfe5c88ad6081e284d0caf36cf8d7e80fe39b676")
        (revision "2738")
        (base zig-0.15.0-1459))
    (package
      (inherit base)
      (name "zig")
      (version (git-version "0.15.0" revision commit))
      (source (zig-source
               version commit
               "0n07x30sy8q2lvh2c0bcs3lsfbk24406sgdp1m31ggg4770dh5n6"))
      ;; zig2
      (arguments (package-arguments zig-0.10.0-851))
      (native-inputs
       (modify-inputs native-inputs
...
(define zig-0.15.0-2807
  (let ((commit "4a310ce7c13c9aa485200a2b712562ba20854272")
        (revision "2807")
        (base zig-0.15.0-2738))
    (package
      (inherit base)
      (name "zig")
      (version (git-version "0.15.0" revision commit))
      (source (zig-source
               version commit
               "0628ig8j16r3y38irr5gbqn0zbrh0vwfd1a8knrgx36f1b0ggdqz"))
      ;; zig1
      (arguments (package-arguments zig-0.10.0-747))
      (native-inputs
       (modify-inputs native-inputs
...
(define zig-0.15.0-2821
  (let ((commit "3edaef9e011ac500f66c9ee0ba3ea24be905bcde")
        (revision "2821")
        (base zig-0.15.0-2807))
    (package
      (inherit base)
      (name "zig")
      (version (git-version "0.15.0" revision commit))
      (source (zig-source
               version commit
               "1rr2ignpb9xjxqk27qk6fswmsv07px6dplj9h3wrw3qvl48ppzmz"))
      ;; zig2
      (arguments (package-arguments zig-0.10.0-851))
      (native-inputs
       (modify-inputs native-inputs
...
(define zig-0.15.0-2876
  (let ((commit "0978566db8b7ed2b730cf01a7d359e9b52ec66ec")
        (revision "2876")
        (base zig-0.15.0-2821))
    (package
      (inherit base)
      (name "zig")
      (version (git-version "0.15.0" revision commit))
      (source (zig-source
               version commit
               "0vx54cw1brk4cjjh217ygwk3kwdjc3a465h2mp43j2wpycq6hd0d"))
      ;; zig1
      (arguments (package-arguments zig-0.10.0-747))
      (native-inputs
       (modify-inputs native-inputs
