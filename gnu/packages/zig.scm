...
(define zig-0.9-glibc-abi-tool
  (origin
    ...
    (file-name "zig-0.9-glibc-abi-tool-checkout")
    (sha256
...
(define-public zig-0.9
  (package
    ...
    (native-inputs
     (modify-inputs `(("glibc-abi-tool" ,zig-0.9-glibc-abi-tool))
       (prepend llvm-13)))
    (native-search-paths
     (list
...
(define zig-0.10-glibc-abi-tool
  (origin
    ...
    (file-name "zig-0.10-glibc-abi-tool-checkout")
    (sha256
              ...
              (add-after 'unpack 'restore-lib
                (lambda _
                  (let ((path "lib/std/start.zig"))
                    (copy-file (string-append #+zig-0.10.0-2565-source "/" path)
                               path))))))))
      (native-inputs
       (modify-inputs (package-native-inputs base)
         (replace "zig" `(,base "out")))))))
...
(define zig-0.11-glibc-abi-tool
  (origin
    ...
    (file-name "zig-0.11-glibc-abi-tool-checkout")
    (sha256
...
(define zig-0.13-glibc-abi-tool
  (origin
    ...
    (uri (git-reference
          (url "https://github.com/ziglang/glibc-abi-tool")
          (commit "fc5d0a7046b76795e4219f8f168e118ec29fbc53")))
    (file-name "zig-0.13-glibc-abi-tool-checkout")
    (sha256
     (base32 "1q9plbqkkk3jzrvsgcjmj5jjdncz4ym9p0snglz4kkjwwm65gqs1"))))
