...
(define firefox-l10n
  (let ((commit "333e7dfd75239b0d54cbfb27d4d39e29c9b8c836"))
    (origin
      (method git-fetch)
      (uri (git-reference
      ...
      (sha256 (base32 "15japvv3yx4rw1a4bjwbpmg4ncn0b8nnyh1pmiadc28gmvnwa60k")))))
...
(define %librewolf-build-id "20250806161508")
  ...
  (package
    ...
    (source
     (make-librewolf-source
      #:version version
      #:firefox-hash "0fkzsfbrn1zlv6cby0pp454ddysa0n6146lgvvrrmlka5zz3fff3"
      #:librewolf-hash "0mrry4jkdsln9a2qycw4qfndybiyby730w2197f3iqi4j9r5111k"
      #:l10n firefox-l10n))
