...
(define firefox-l10n
  ...
  (let ((commit "ec0a48f0301f2c82c2d3fe9fbe07e30869bb345b"))
    (origin
      (method git-fetch)
      (uri (git-reference
      ...
      (sha256 (base32 "0f4h8dwih1gv9s0bkiaqv3dy066n5yfydr1aa7s6hl2h1rc51plg")))))
...
(define %librewolf-build-id "20260623152004")
  ...
  (package
    ...
    (source
     (make-librewolf-source
      #:version version
      #:firefox-hash "0fsxg857d8lpypzgn3np1r1mqi751x8l60pn1zpmxiwywxag9wvr"
      #:librewolf-hash "0zw1nyp4mhx3ircspamywyghdb9wyfzj9k4z643xlvadxcfg808a"
      #:l10n firefox-l10n))
