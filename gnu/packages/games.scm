...
(define-public sgt-puzzles
  (let ((commit "7ad37c64af3bc891372ec16db1531cee599b6e3a")
        (revision "0"))
    (package
      (name "sgt-puzzles")
      (version (git-version "20260622" revision commit))
      (source
       (origin
         (method git-fetch)
         (uri (git-reference
         ...
         (file-name (git-file-name name version))
         (sha256
          (base32 "0aldj32fr51wmdnmr7dywf19s3a8l9sxfnnk34wi8fgzzmskl0z9"))))
      (build-system cmake-build-system)
      (arguments
       (list
        #:tests? #f                     ;No tests.
  ...
  (package
   ...
   (source
    (origin
     ...
     (sha256
      (base32 "1s09qqy2r58gv0ai3xx8dv7a7qkcn5kg5jwv2pplk7wv5bq0ha6k"))))
   (build-system gnu-build-system)
   (inputs
     ...
     `(("cppunit" ,cppunit)
       ...
       ("flightgear-data"
        ,(origin
           ...
           (sha256
            (base32
             "0ypr92nj1m229gw3jmyn67jk8qfbqbh7hgzbalwimvpmrx8s87fy"))))))
...
(define-public hedgewars
  (package
    ...
    (native-inputs
     (list clang-13 ghc pkg-config qttools-5))
