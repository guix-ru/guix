  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name "ocaml" version))
       (sha256
        (base32 "0bpfwdfc7j53hb57arb6nxdj0ahkcxzkbj2ax90nvkjcyr96xcr3"))))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0h87qjhc6v39ci4avi6q190p4k8jq71p1ch62c6n49s19z0d3ry7"))))
    (build-system dune-build-system)
    (arguments
     `(#:package "ppxlib"
       #:phases (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (janestreet-git-origin "ppxlib_jane" version
      "1vc0hi73b3hsfkrl83jgz777hz4whyb0z4y4qr8ynvif7mlpp8bj"))
    (build-system dune-build-system)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1f3183jqybg6f4fviij1hvj4cbj709jdh8x9a57ya3dgahamzw2i"))))
    (build-system dune-build-system)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0vvxi0ipxmdz1k4h501brvccniwf3wpc32djbccyyrzraiz7qkff"))))
    (build-system dune-build-system)
    (native-inputs (list ocaml-alcotest))
    (home-page "https://github.com/hannesm/duration")
    (synopsis "Conversions to various time units")
    (description
     "This package provides a duration in nanoseconds represented as an
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "11p3ai8g993algds9mbg4xf3is0agqah127r69fb7rm35dryzq95"))))
    (build-system dune-build-system)
    (arguments
     '(#:package "mirage-profile"
       ;; depends on ocaml-mirage-profile-unix which would form a loop
       #:tests? #f))
    ...
    (description
     "This package is used to trace execution of OCaml/Lwt programs (such as
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1wv2hz1dj38jzc8nabin9p8im43ghy8f3crv7rf9szyyzyrdanp2"))))
    (build-system dune-build-system)
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1qj32bcw1in7s6raxdvbmjr3lvj99iwv98x1ar9cwxp4zf8ybfss"))))
    (build-system dune-build-system)
