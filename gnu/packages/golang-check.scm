  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1n9y3l4jga1wfha82pklh2llggf2z2r2v64vaq3xz1vj35mq4cgk"))))
    (build-system go-build-system)
    (arguments
     (list
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0k9l146rcz1bjg3jrbz8hy1xjrns8gl4diqzd2nsha1d56yysz6g"))))
    (build-system go-build-system)
    (arguments
     (list
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1qa1vx4129bdlzwlk3lwy69cim0rmicqxfpbyk0payyin9flm1bs"))))
    (build-system go-build-system)
    (arguments
     (list
      #:skip-build? #t
      ...
      #:test-flags
      #~(list "-skip" (string-join
                       ;; XXX: Diffs are not equal.
                       (list "TestDiff"
                             "TestMatchInlineSnapshot"
                             "TestMatchJSON"
                             "TestMatchSnapshot"
                             "TestMatchStandaloneJSON"
                             "TestMatchStandaloneSnapshot"
                             "TestMatchStandaloneYAML"
                             "TestMatchYAML"
                             "TestSummary")
                       "|"))
      #:phases
...
(define-public go-github-com-go-openapi-swag-jsonutils-fixtures-test
  (package
    (name "go-github-com-go-openapi-swag-jsonutils-fixtures-test")
    (version "0.27.0")
    (source
     (origin
       (method git-fetch)
       (uri (git-reference
              ...
              (commit (go-version->git-ref version
                                           #:subdir "jsonutils/fixtures_test"))))
       (file-name (git-file-name name version))
       (sha256
       ...
       (snippet
        #~(begin
            ...
            (delete-all-but "jsonutils" "fixtures_test")
            (delete-all-but "." "jsonutils")))))
    (build-system go-build-system)
    (arguments
     (list
      #:import-path "github.com/go-openapi/swag/jsonutils/fixtures_test"
    ...
    (synopsis "Test [Harness] utility for Go")
    (description
     "Package fixtures exposes a test @code{[Harness]} utility to test JSON
  ...
  (package
    ...
    (arguments
     (list
      ...
      #~(list "-vet=off"
              "-skip" (string-join
                       ;; Analyze: invalid analyzer name ""
                       (list "Test_Maps_Ignore/notignore"
                             "Test_Maps_Ignore/ignore"
                             "Test_Maps_Ignore/havecomment")
                       "|"))
...
XML report, suitable for applications that expect JUnit-style XML
...
(define-public go-github-com-uudashr-gocognit
  (package
    ...
    (description
     "This package calculates cognitive complexities of functions (and
methods) in Go source code.")
    (license license:expat)))
...
(define-public go-noctx
  (package/inherit go-github-com-sonatard-noctx
    (name "go-noctx")
    (arguments
     (substitute-keyword-arguments arguments
       ((#:import-path _) "github.com/sonatard/noctx/cmd/noctx")
       ((#:install-source? _ #t) #f)
       ((#:skip-build? _ #t) #f)
       ((#:tests? _ #t) #f)
       ((#:unpack-path _ "") "github.com/sonatard/noctx")))
    (native-inputs
     (package-propagated-inputs go-github-com-sonatard-noctx))
    (inputs '())
    (propagated-inputs '())))
