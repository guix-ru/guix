  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "01ms8mfvbb3qf2qnkpd0biqpjawzfjkblfaw489czl78ad2hfa3d"))
       (file-name (git-file-name name version))))
    (build-system cmake-build-system)
    (native-inputs
     (list gfortran))
...
(define-public celestia-content
  ...
  (let ((commit "cd835cbb61f71cc339276391af06cd04d6d11bef")
        (revision "9"))
    (package
      ...
      (source
       (origin
         ...
         (file-name (git-file-name name version))
         (sha256
          (base32 "0vs5mwayaazzvc3d2z0870gfpqfyign9418s5px8dai06hc364ig"))))
      (build-system cmake-build-system)
      (arguments
       (list
        #:tests? #f))   ;no tests were found
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0v8nwgh1kn7w988d8zjd4dzwq1hw24vw481xwyz6xdysizh5d9i7"))))
    (properties
     (alist-delete 'hidden?
