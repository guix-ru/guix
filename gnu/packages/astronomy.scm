...
(define-public celestia-content
  ...
  (let ((commit "188b22b4cf036cd5618402829d5cc0386d39f484")
        (revision "8"))
    (package
      ...
      (source
       (origin
         ...
         (file-name (git-file-name name version))
         (sha256
          (base32 "027bw4b7i6k878kv53r05fqzjs95cl0wqjsvwxpcm2d73j1ix2bp"))))
      (build-system cmake-build-system)
      (arguments
       (list
        #:tests? #f))   ;no tests were found
...
(define-public python-astropy-7
  (package
    ...
    (propagated-inputs
     (modify-inputs propagated-inputs
       (replace "python-astropy-iers-data"
         python-astropy-iers-data-next)))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0ajq39nyqzx9kina20i9pksnjhzqb9kq30gzlvyv1dfz0y49x2b0"))))
    (build-system pyproject-build-system)
    (arguments
     (list
      ;; tests: 81 passed, 1 skipped, 25 deselected, 17 warnings
      #:test-flags
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1kgnmp65a3d1h7hd69clhvsfkcj5ishgx63k2vx15xh2ssc45ckz"))))
    (build-system pyproject-build-system)
    (arguments
     (list
      ;; tests: 1892 passed, 831 skipped, 9 xfailed, 1 xpassed, 264 warnings
      #:test-flags
      #~(list "--durations=20"
              "--numprocesses" (number->string (min 8 (parallel-job-count)))
              "--pyargs" "gammapy")
...
Scipy and Astropy.  It is used as core library for the Science Analysis tools
of the Cherenkov Telescope Array (CTA), recommended by the
H.E.S.S. collaboration to be used for Science publications, and is already
widely used in the analysis of existing gamma-ray instruments, such as
@acronym{MAGIC, Major Atmospheric Gamma Imaging Cherenkov Telescopes}
@acronym{VERITAS, Very Energetic Radiation Imaging Telescope Array System} and
@acronym{HAWC, The High-Altitude Water Cherenkov Gamma-Ray Observatory}.")
    (license license:bsd-3)))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "068gr8afildh81za89jnd7zhspzri0m38pj7ypvamwmyfdk2jjrd"))))
    (build-system pyproject-build-system)
    (arguments
     (list
...
(define-public python-pyhdrl
  (package
    ...
    (propagated-inputs
     (list python-pycpl))
    ;; I could not find actual homepage of the project on
    ;; <https://www.eso.org/public/about-eso/>, and
    ;; <https://www.eso.org/sci/software/pycpl/pyhdrl-site/> is broken link.
    (home-page "https://www.eso.org/public/")
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "132hsjka0k0gkv2ikrps0l2zsy2md71r7gq5sxsjvsdygiwarqnv"))))
    (build-system pyproject-build-system)
    (arguments
     (list
      ;; tests: 584 passed, 130 skipped, 1 deselected, 3 xfailed
      #:test-flags
...
(define-public python-stpreview
  (package
    ...
    (build-system pyproject-build-system)
    (arguments
     (list #:tests? #f)) ;depends on python-roman-datamodels@0.28
    (native-inputs
     (list python-setuptools
           python-setuptools-scm))
    (propagated-inputs
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "17vjmg94mj3wwiv7jb1ngq9vyyywz3073pz1gcn7riy8y3q24a8j"))))
    (build-system pyproject-build-system)
    (arguments
     (list #:tests? #f)) ;tests need to download remote datasets
    (native-inputs
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "12iccq0b9g8pmranja5rmayrlxbayy1h6w6v9grs764gf85g2wql"))))
    (build-system gnu-build-system)
    (arguments
     (list
      #:configure-flags
    ...
    (source
     (origin
       ...
       (uri (git-reference
             ...
             (commit version)))
       (sha256
        (base32 "182f3xj0dkmansn1fbxiqzrx5ncjx5mcn9nxgdgvjryaz3qirzhk"))
       (file-name (git-file-name name version))
       (modules '((guix build utils)))
       (snippet
        #~(begin
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0wniyp6rw2gcv1plqdqqx8l9qa1yr2rap6yhhq628ynj846v0xk4"))))
