...
(define-public celestia-content
  ...
  (let ((commit "ea14adef2617536df5ed793fe4bfb61b8818d1ee")
        (revision "1"))
    (package
      ...
      (source
       (origin
         ...
         (file-name (git-file-name name version))
         (sha256
          (base32 "0vk22kq8j0zw9gsagvj02w8hwb4s3iz63slhsr03l5zbd7gqhslz"))))
      (build-system cmake-build-system)
      (arguments
       (list
        #:tests? #f))   ;no tests were found
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0f3d8rjrlm3dnhccacg7xgxh2i55akvbkzwcipl1170svbs45rnk"))))
    (build-system cmake-build-system)
    (arguments
     (list
