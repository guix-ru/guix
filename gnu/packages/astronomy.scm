...
(define-public celestia-content
  ...
  (let ((commit "a76199c8bce62761ad577dc5c3523fb4925e09b7")
        (revision "7"))
    (package
      ...
      (source
       (origin
         ...
         (file-name (git-file-name name version))
         (sha256
          (base32 "0lgpy7rxpnf31w2dlwf1xvp1lf19xwfzj38vq1qjhzm81hbw9ml8"))))
      (build-system cmake-build-system)
      (arguments
       (list
        #:tests? #f))   ;no tests were found
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1lnzm3jhanq8fs00fx4q1r2sy58wy6x5x7z83zys5spwh9hs6qjm"))))
    (build-system pyproject-build-system)
    (arguments
     (list #:tests? #f)) ;tests need to download remote datasets
    (native-inputs
