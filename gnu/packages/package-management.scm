...
(define-public guix-pin
  (let ((commit "327fbd349e97b71452ba91fdae5680c5af860107")
        (revision "0"))
    (package
      (name "guix-pin")
      (version (git-version "0.0.0" revision commit))
      (source
       (origin
         (method git-fetch)
         (uri (git-reference
                (url "https://codeberg.org/guix-extensions/pin")
                (commit commit)))
         (file-name (git-file-name name version))
         (sha256
          (base32 "1i9926qzjvd3aslyk84b8r2sdbfqlm8mw0hkfd558bmkhamhyrs2"))))
      (build-system guile-build-system)
      (arguments
       (list
        #:scheme-file-regexp
            ...
            (add-after 'build 'move-to-extension-directory
              (lambda _
                (with-directory-excursion #$output
                  ...
                  (rename-file (string-append "share/guile/site/"
                                              (target-guile-effective-version)
                                              "/guix/extensions/pin.scm")
                               "share/guix/extensions/1.5/guix/extensions/pin.scm")))))))
      (native-inputs (list guix bash-minimal))
      (inputs (list (lookup-package-input guix "guile")))
      (home-page "https://codeberg.org/guix-extensions/pin")
      (synopsis "Pinpoint channels file to a specific commit")
      (description
       "This extension provides the @command{guix pin} command, which allows
you to pinpoint a channels file to a specific commit.")
      (license license:gpl3+))))
...
(define-public guix-package-version-history
  (let ((commit "e5dc46b7f1b944cde8cd964ac060510003cf45ee")
        (revision "0"))
    (package
      (name "guix-package-version-history")
      (version (git-version "0.0.0" revision commit))
      (source
       (origin
         (method git-fetch)
         (uri (git-reference
                (url
                 "https://codeberg.org/guix-extensions/package-version-history.git")
                (commit commit)))
         (file-name (git-file-name name version))
         (sha256
          (base32 "0mqmk4fdrlhvv0ajx07180li53lam8pjrr8hryw2jzmh53df4j3s"))))
      (build-system guile-build-system)
      (arguments
       (list
        #:scheme-file-regexp
            ...
            (add-after 'build 'move-to-extension-directory
              (lambda _
                (with-directory-excursion #$output
                  ...
                  (rename-file (string-append "share/guile/site/"
                                              (target-guile-effective-version)
                                              "/guix/extensions/package-version-history.scm")
                               "share/guix/extensions/1.5/guix/extensions/package-version-history.scm")))))))
      (native-inputs (list guix))
      (inputs (list (lookup-package-input guix "guile")))
      (home-page
       "https://codeberg.org/guix-extensions/package-version-history")
      (synopsis "Find commits providing a given package version")
      (description
       "This extension provides the @command{guix package-version-history}
command, which allows you to finds the commits providing a given package
version, or several package versions at once.")
      (license license:gpl3+))))
...
(define-public guix-build-coordinator
  (let ((commit "22988c0ae967e78de408d5160bda895caf5d8fee")
        (revision "145"))
    (package
      ...
      (source (origin
                ...
                (sha256
                 (base32
                  "11in6xc4s992yh7jyp72kpk1ls2ydll29zwz3ja6135gqwrj3f6x"))
                (file-name (string-append name "-" version "-checkout"))))
      (build-system gnu-build-system)
      (arguments
       (list
