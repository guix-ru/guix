...
(define-public guix
  ...
  (let ((version "1.5.0")
        (commit "76c084f5c74d7c38e741eba1633c9f331da7a6db")
        (revision 3))
    (package
      (name "guix")
      ...
      (source (origin
                ...
                (sha256
                 (base32
                  "0q2nsdfy3zrirjvjqy80cxij1svgf9mzkccpqkv761klw3n4v4qs"))
...
(define-public bffe
  (let ((commit "fc725c5d05a61600c39abeb1680ece8a6c208cf7")
        (revision "20"))
    (package
      (name "bffe")
      ...
      (source (origin
                ...
                (sha256
                 (base32
                  "16b9i026zjixmbg333xnin00bqhabmcwkdsdb2y29jsgr3qlnxn2"))
