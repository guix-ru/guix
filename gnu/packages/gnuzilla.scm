...
(define %icecat-version (string-append %icecat-base-version "-gnu0-preview1"))
(define %icecat-build-id "20250620000000") ;must be of the form YYYYMMDDhhmmss
...
(define icecat-source
  (let* ((major-version (first  (string-split %icecat-base-version #\.)))
         ...
         (gnuzilla-commit "6887b88eee4b6a635c3b664d8c2955ab0164498c")
         (gnuzilla-source
          (origin
            (method git-fetch)
            (uri (git-reference
