...
(define-public direvent
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1dywdzwzjn1g7cpm2f1mz0iasdhjn0ddhcagkcz6gxz6nfsc05hf"))))
    (build-system gnu-build-system)
    (arguments
     (list #:phases
           #~(modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0vdv658izj6kxhhvhq940753mg00j3n2933y9bhgypma19yxa9n6"))))
    (build-system gnu-build-system)
    (inputs
  ...
  (package
    ...
    (source
     (origin
      ...
      (file-name (git-file-name name version))
      (sha256
       (base32 "1vwnigyygzch2pxszqbhs4vpjkzpc5pf0k7p5fxmsanmf5mp76m6"))))
    (build-system gnu-build-system)
    (arguments
     (list
      #:configure-flags
...
(define-public atop
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0x58wrkaz9hp6cwr4bsg19029x3zz7gifkxgwliajb7mr622y67a"))))
    (build-system gnu-build-system)
    (arguments
     (list
       #:tests? #f              ; no test suite
