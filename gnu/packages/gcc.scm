  ...
  (package
   ...
   (source (origin
            ...
            (patches (search-patches "gcc-9-strmov-store-file-names.patch"
                                     ...
                                     "gcc-libstdc++-newer-gcc.patch"
                                     "gcc-11-libsanitizer-Fix-build-with-glibc-2.42.patch"
                                     "gcc-sanitizer_common-Remove-reference-to-obsolete-termio-ioctls.patch"))
            (modules '((guix build utils)))
            (snippet gcc-canadian-cross-objdump-snippet)))
   (properties
    `((compiler-cpu-architectures
  ...
  (package
    ...
    (source (origin
              ...
              (patches (search-patches "gcc-12-strmov-store-file-names.patch"
                                       ...
                                       "gcc-11-libstdc++-hurd-libpthread.patch"
                                       "gcc-libstdc++-newer-gcc.patch"
                                       "gcc-libsanitizer-Fix-build-with-glibc-2.42.patch"
                                       "gcc-sanitizer_common-Remove-reference-to-obsolete-termio-ioctls.patch"))
              (modules '((guix build utils)))
              (snippet gcc-canadian-cross-objdump-snippet)))
   (properties
...
(define-public gcc-13
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0mcq768c0c1w2gsasbxh489fnw1hvasdb74s3zwi256hbq0z0ggc"))
              (patches (search-patches "gcc-12-strmov-store-file-names.patch"
                                       "gcc-5.0-libvtv-runpath.patch"
...
(define-public isl
  (package
    ...
    (source (origin
             ...
             (sha256
              (base32
               "0p1xcijrjmzp0j5kzbz601p3p0bv7x7qf3l7ny62wrvvksssp2vd"))))
    (build-system gnu-build-system)
    (outputs '("out" "static"))
    (arguments
