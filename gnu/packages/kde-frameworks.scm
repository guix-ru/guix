...
(define-public kdbusaddons
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0y928q8gpfllrysjji7mr3d0p54ncyn8kggfy4ijqgpgzrqyxx5m"))))
    (build-system qt-build-system)
    (native-inputs
...
(define-public kdnssd
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0aapf05xsz645j5wrv7q2vfn5k204j05pg6bzvq37484yf92rmvk"))))
    (build-system cmake-build-system)
    (native-inputs
  ...
  (package
    ...
    (source (origin
              ...
              (uri (string-append
                    ...
                    name "-" version ".tar.xz"))
              (sha256
               (base32 "1r1b8g86n9kjih5z8mzkv6vanjzzwxclb5qk48dpgsjjyq7q5rli"))))
    (build-system cmake-build-system)
    ...
    (source
     (origin
       ...
       (uri (string-append "mirror://kde/stable/frameworks/"
                           ...
                           name "-" version ".tar.xz"))
       (sha256
        (base32 "0gn2cv3vgi0p31nkmgr57y70sfisg0qncgqh40fpf4y44xg98fpq"))))
    (build-system cmake-build-system)
    (arguments (list #:tests? #f))
    (native-inputs
...
(define-public kitemviews
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0ika2n7h1hg7wwinfsmckk7bjg1wzdjd97cq7p5isgljzxp87aiv"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules qttools))
    (arguments (list #:qtbase qtbase))
...
(define-public kwayland
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0f9xivwm762i84grxldpihl1nhrvs48cqrjrql6fs2ra80dkgdzb"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules pkg-config
           ;; for wayland-scanner
...
(define-public kwindowsystem
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1njrgs150hs3sj410kaj82b2aa4v0vd7q9jwcpj9iz1pdk671y3y"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules
           pkg-config
    ...
    (source
     (origin
       ...
       (uri (string-append "mirror://kde/stable/frameworks/"
                           ...
                           name "-" version ".tar.xz"))
       (sha256
        (base32 "0mjkgl332k28b31326kwidwzh7j11h0pjrln97n2bbq0bvwj7mmz"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
...
(define-public qqc2-desktop-style
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0dc5bzh8ff5bchkpbrj6wwml4da7xxkq6b829wjbl3wbdqzvkyb8"))))
    (build-system qt-build-system)
    (arguments
     (list
      #:qtbase qtbase
...
(define-public kcompletion
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0h6xds86my4a1pjbvyfp0azvf4lwmpr5p04i4p6smqrqigldcwcb"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules qttools))
    (inputs
...
(define-public kcrash
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1pb2672cxqbi5majq56y85fnmnzckscdhspkn8jm2z50fl5h3svz"))))
    (build-system qt-build-system)
    (native-inputs (list extra-cmake-modules))
...
(define-public kdoctools
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1g3l7irjzypjgalq2giskilnks1c6xpprz92pbwl0x94g4lqn162"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
...
(define-public kjobwidgets
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0xdc5q1lwmh16ylk74hzpbpax65gx08al8k995kxf34r11nr7m6v"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules qttools))
    (inputs
...
(define-public kdeclarative
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "143szzdx0baf8scrs9rfjwg7km1ckc2nv0xy0vx20ys4iyhajw8c"))))
    (build-system cmake-build-system)
    (propagated-inputs
...
(define-public knewstuff
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1zqsb74f2cfq6fb5bn5fslbw301w2a40q5ddk2x399jgy21gp43h"))))
    (build-system cmake-build-system)
    (propagated-inputs
     (list attica
           kcoreaddons))
...
(define-public kservice
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1gb1162cp69f25szqwi9jj53bwfwigvsy9i7x610zfbb7r4hhpl1"))))
    (build-system cmake-build-system)
    (propagated-inputs
