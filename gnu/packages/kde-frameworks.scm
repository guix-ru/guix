...
(define-public extra-cmake-modules
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "18z6l65n6zhaqsyg0s61j87mkl7yykfj17am0af0k3jqfvhzgwwf"))))
...
(define-public bluez-qt
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1cssbvi3ap7sbk70sllkkc10409ha7zfphwsskd1f15zl9ygfz4h"))))
    (build-system cmake-build-system)
    (native-inputs
...
(define-public kcodecs
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1xynxx5633wa0xzwgcami134r3b15g2r9mjfv5jjy1afjiqs642h"))))
    (build-system cmake-build-system)
...
(define-public kcoreaddons
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0z7z1rmpr39rndjjqc3y93hsqwphhh2n44vlpkkgcng89pcv0bxw"))))
    (build-system qt-build-system)
...
(define-public kdbusaddons
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "04ddd3qj3kssn7hvp8iglak4q6mkgpwbiblzw1mp1zkxm4qi963n"))))
    (build-system qt-build-system)
    (native-inputs
...
(define-public kdnssd
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "18693j6sqa7yymjn7b0pkxycfk6gfmgi5dsfdd1i2ahi2v9zdyrc"))))
    (build-system cmake-build-system)
    (native-inputs
    ...
    (source
     (origin
       ...
       (uri (string-append "mirror://kde/stable/frameworks/"
                           ...
                           name "-" version ".tar.xz"))
       (sha256
        (base32 "01nb7jx545alp9ag5jaa8902f5xyxzxgafwpx5aiy2lhj73y135y"))))
    (build-system cmake-build-system)
    (arguments (list #:tests? #f))
    (native-inputs
...
(define-public kirigami
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1kmhlpg14593dmrx2y9idf7lmba9snwbwda34i27v1j9wgglfckv"))))
    (build-system cmake-build-system)
    (arguments
     (list
      #:phases
...
(define-public kitemviews
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1yl2454fciq6psspkrjmj7xfjg08chsml4bk7s4yg0i7fw0qpwy7"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules qttools))
    (arguments (list #:qtbase qtbase))
...
(define-public ksyntaxhighlighting
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0va8cn579kn2c6lfv1jzpd9yp0gclpxd9ixrj7xfqw31vi35j706"))))
    (build-system cmake-build-system)
    (native-inputs
...
(define-public kwayland
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "15ykrwi0mnxx2sg7x5hdpggxkqpzdp9f22wl56sgiiyfvrg11c2x"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules pkg-config
           ;; for wayland-scanner
...
(define-public kwidgetsaddons
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "01q1qa2a79m28wz63b1ycvc541b10fgkfkysl7l7530digjn7rfz"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules qttools))
    (arguments
...
(define-public kwindowsystem
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0n1yy5ll31rrnhqd3vfn60qpg4pxgkx1y37arrii5f786rcdk492"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules
           pkg-config
...
(define-public modemmanager-qt
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1lhfx225w9c7lrzr59pmhv90mgiz4fa40bamh1wrsz72367gyn66"))))
    (build-system cmake-build-system)
    (native-inputs
...
(define-public networkmanager-qt
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1zqgxyig5x4yy7yvpzrm72yravb742rq2i17nj3kydalw204zm5r"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules dbus pkg-config))
    (inputs (list qtbase))
...
(define-public pulseaudio-qt
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1jdkfsdfg2vq1sz0dy11iw46s2d176nk9ckz61ysl228p5arqqbr"))))
    (build-system cmake-build-system)
    (arguments (list #:configure-flags #~(list "-DBUILD_WITH_QT6=ON")))
    (native-inputs
     (list extra-cmake-modules pkg-config))
...
(define-public qqc2-desktop-style
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0r6y4aqv0pmfyqigvzclzpkfvcqa6dd2fj0r6whzs7bgb4dpm5j5"))))
    (build-system qt-build-system)
    (arguments
     (list
      #:qtbase qtbase
...
(define-public sonnet
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1rwsxvqa3zq2w92kj46z2cswxsxw24sfq5y7mjxr6k0m9nyhgwgm"))))
    (build-system qt-build-system)
    (arguments (list #:qtbase qtbase))
    (native-inputs
     (list extra-cmake-modules pkg-config qttools))
...
(define-public threadweaver
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0vylbrg1bkhghc8lra73valmnv5sxb8yjainr2ywvrwp2fb0hxma"))))
    (build-system cmake-build-system)
    (native-inputs (list extra-cmake-modules))
    (inputs (list qtbase))
    (home-page "https://community.kde.org/Frameworks")
...
(define-public kcrash
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0x40xw00cc11g6ydfh69gc69bmrx10gmpbrd6i37wn4n7j644i25"))))
    (build-system qt-build-system)
    (native-inputs (list extra-cmake-modules))
...
(define-public kdoctools
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1m30jqnksgn8cjyyq9fwwq75g32pr0hfbb8lq7316f3q5z2m3qxf"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs
...
(define-public kfilemetadata
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "08yfl8d7zbgajfm2axgrvklr0d82fvbrbzhiyrk1zbzrmkmw5z9f"))))
    (build-system cmake-build-system)
    (arguments
     (list
      #:test-exclude
...
(define-public kimageformats
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1qhn9zh44ai8r37q41cj2z6k2s917bjz147k4dvf69r27s33b7by"))))
    (build-system cmake-build-system)
    (native-inputs
     (list extra-cmake-modules pkg-config))
    (inputs
...
(define-public knotifications
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0h19wi493k6a44vss2jd06li5bi6yllhpk49s6b9pqwsmhs0pfqj"))))
    (build-system cmake-build-system)
    (arguments
     (list #:tests? #f
           #:configure-flags
...
(define-public baloo
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1r2w361axff4mfc3khsq8zd9dly5yavlz4vir606nqxr2xl6fwhz"))))
    (build-system cmake-build-system)
    (propagated-inputs
...
(define-public kdeclarative
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "05b92c5shmb1nq96w7c810q2pnraymsbr4jfhqb5lynfm1x6j3fh"))))
    (build-system cmake-build-system)
    (propagated-inputs
...
(define-public kdesu
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1lq7m109ad1cd8dajq9xs7wr55rxcgsvpkifcg19cgag5h0dsnmy"))))
    (build-system cmake-build-system)
    (propagated-inputs
     (list kpty))
    (native-inputs
...
(define-public kglobalaccel
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "02mgnnln3rhjgvps7gcxqgyqdx8p2sq63k0k4x0balg9jpsd3icx"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules pkg-config qttools))
    (inputs
...
(define-public knotifyconfig
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1dl33mp0pgmwjgbdw4fz4d2aps73rnl4nhrjzf48hlvapiz91sj6"))))
    (build-system cmake-build-system)
    (arguments (list #:tests? #f))
    (native-inputs
     (list extra-cmake-modules))
...
(define-public kservice
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "08wpffqzyl07b16h4vjk8x5wj77bmb2sz5nf1xnd2j99npxfbczp"))))
    (build-system cmake-build-system)
    (propagated-inputs
...
(define-public kstatusnotifieritem
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1zw6z20yq587m48gg0msvpfi3319c1n6v6ij61rh0q3sqbf7fv7p"))))
    (build-system qt-build-system)
    (arguments
     (list
      #:configure-flags
...
(define-public ktexteditor
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1qvq7wvjdcwcc2b03ddyq61fp03qmp1kgy29m0h0xb8jfxvkqw7x"))))
    (build-system cmake-build-system)
    (propagated-inputs
     (list kparts
           ksyntaxhighlighting))
...
(define-public ktextwidgets
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "05bd11il2zkblz5701h83rv08v6vl7sizk702gxcvasa04hpv3xs"))))
    (build-system qt-build-system)
    (propagated-inputs
     (list ki18n sonnet))
    (native-inputs
...
(define-public ktexttemplate
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "1q482jhd8cgf9zfkps7pk0sls2y99zzms1q13ddzw28xyrliy0l5"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (inputs (list qtdeclarative))
...
(define-public kxmlgui
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "05ing5g40ycxxh50rz8zffqhxb28k3i7q5cxmqv8npb74drqhzzq"))))
    (build-system cmake-build-system)
    (propagated-inputs
     (list
    ...
    (source
     (origin
       ...
       (uri (string-append "mirror://kde/stable/frameworks/"
                           ...
                           name "-" version ".tar.xz"))
       (sha256
        (base32 "04r9chakc22i6srysh8w43944ak631941wmdpqphsfj0an36kidc"))))
    (build-system qt-build-system)
    (native-inputs
     (list extra-cmake-modules))
    (propagated-inputs (list kcoreaddons))
