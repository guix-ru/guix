  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1j6vvrv8zvllxwcgjcg2zhqs5apm2w7hgrqqfpbfqjh16p4cjgag"))))
    (build-system cmake-build-system)
    (arguments
     `(#:configure-flags
...
(define-public socat
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "06ywg8rf4m5z7hsi0ja60rz4qq9sclhnas86i3wm6w22gxmn7g2y"))))
    (build-system gnu-build-system)
  ...
  (package
    ...
    (source
     (origin
       ...
       (hash
        (content-hash
         (base32 "02w726f413fsa375b5l2i46r7j7n74imnvbdha3ycz3wh85fqdm2")
         sha256))
       (file-name (git-file-name name version))))
    (build-system gnu-build-system)
    (inputs
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1flwsxvhdj8xamr48z7z0272i9ffm9fpgij22vjk2ykjvsdrimvy"))))
    (build-system cmake-build-system)
    (arguments
     (list
