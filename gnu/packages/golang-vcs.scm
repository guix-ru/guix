...
(define-public go-github-com-bluekeyes-go-gitdiff
  (package
    (name "go-github-com-bluekeyes-go-gitdiff")
    (version "0.7.1")
    (source
     (origin
       (method git-fetch)
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "1hafhl5z7vfqg388fr3y61fvpyfs1dv7cv351cxl8v265an88wh4"))))
    (build-system go-build-system)
    (arguments
     (list
      #:import-path "github.com/bluekeyes/go-gitdiff"
      #:skip-build? #t))
    (home-page "https://github.com/bluekeyes/go-gitdiff")
    (synopsis "Parse and apply Git-style diffs in Go")
    (description
     "This package provides a Go library for parsing and applying patches
generated by @code{git diff}, @code{git show}, and @code{git format-patch}.
It can also parse and apply unified diffs generated by the standard GNU
@code{diff} tool.")
    (license license:expat)))
