...
(define-public perl
  ...
  (package
    ...
    (source (origin
             ...
             (sha256
              (base32
               "1hwnbzvc4ckah33r26z58fm8i8yiaz5b3zvax10cp494p5k5119v"))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0smi0rzs1fiih39lww5b0fpjzh22hvvirj8nr261qzd0daayvav4"))))
    (build-system perl-build-system)
    (arguments
     `(#:phases
       (modify-phases %standard-phases
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32
         "1g8njl0wzp4lk2zwhi4z0by801m60c67jszvjbgv98wykhj56y4z"))))
    (build-system perl-build-system)
