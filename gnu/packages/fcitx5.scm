    ...
    (source
     (origin
       ...
       (uri (string-append "https://download.fcitx-im.org/fcitx5/libime/libime-"
                           version "_dict.tar.zst"))
       (sha256
        (base32 "06f21bgf2dwqrz9zy6r8f21lnhnhb9fwmfjln0v1j6v10ssjw245"))))
    (build-system cmake-build-system)
    (inputs
    ...
    (source
     (origin
       ...
       (uri (string-append "https://download.fcitx-im.org/fcitx5"
                           ...
                           version ".tar.zst"))
       (sha256
        (base32 "0hic2wq1azz2zwkpiqa5c2mfqmx2zxhq9i4nx13g1l4653ksm9dx"))))
    (build-system cmake-build-system)
    (arguments
     (list
      #:tests? #f                       ;No test
    ...
    (source
     (origin
       ...
       (uri (string-append "https://download.fcitx-im.org/fcitx5"
                           ...
                           version ".tar.zst"))
       (sha256
        (base32 "0j1k0fm9hlkaicdp4kj2mfnw9h95q9x5lx8jwhbbwjkkhj3rh17h"))))
    (build-system cmake-build-system)
    (arguments
  ...
  (package
    ...
    (source (origin
              ...
              (uri (git-reference
                    ...
                    (commit version)))
              (sha256
               (base32 "0hyy8b9ndh29fa8416ni2r5jrhkhig23d3vg6crgywz8wnnrjhbs"))
              (file-name (git-file-name name version))))
  ...
  (package
    ...
    (source (origin
              ...
              (uri (git-reference
                    ...
                    (commit version)))
              (sha256
               (base32 "027f6xfarbgy80vqhpfkk0risji5l72kyl3wkb8q7hpmfj99l42q"))
              (file-name (git-file-name name version))))
    (build-system cmake-build-system)
    (arguments
     (list #:phases
    ...
    (source
     (origin
       ...
       (uri (string-append "https://download.fcitx-im.org/fcitx5"
                           ...
                           version "_dict.tar.zst"))
       (sha256
        (base32 "1s379aq9215fnxf4l6iqj5gh1bw0g81h9bxvibl8l9rhjbpv8a98"))))
    (build-system cmake-build-system)
    (arguments
     (list #:configure-flags
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0k8jyv7axlksdswpy0n3pllvkg5qcaljh1zb37fykqx05sx4cbaw"))))
    (build-system qt-build-system)
    (arguments
     (list #:qtbase qtbase
           #:tests? #f
...
(define-public fcitx5-rime
  (package
    ...
    (source (origin
              ...
              (sha256
               (base32
                "0qldn0mvpx5pns0xracc44fyhpsxq2q4xdvddvd7qkhxpqgq2y3l"))))
    (build-system cmake-build-system)
    (arguments
     '(#:tests? #f ;no tests
