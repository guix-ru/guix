...
dist_patch_DATA =						\
  ...
  %D%/packages/patches/amberol-port-to-gtk-rs-0.11.patch	\
  ...
  %D%/packages/patches/cvc5-fix-test-failure.patch		\
  ...
  %D%/packages/patches/elogind-fix-logind-dbus-install.patch    \
  ...
  %D%/packages/patches/flann-pc-file.patch                      \
  ...
  %D%/packages/patches/ghc-language-python-fix-build-with-happy-2.patch \
  ...
  %D%/packages/patches/gpu-screen-recorder-privileged-kms-helper.patch \
  ...
  %D%/packages/patches/hdrhistogram-c-no-avx2-on-i386.patch	\
  ...
  %D%/packages/patches/hoogle-crypton-connection-0.4.X.patch	\
  ...
  %D%/packages/patches/ldc-phobos-support-TZDIR.patch		\
  ...
  %D%/packages/patches/miniaudio-CVE-2026-32837.patch		\
  ...
  %D%/packages/patches/nchat-whatsmeow.patch			\
  ...
  %D%/packages/patches/ogre-double-free.patch                   \
  ...
  %D%/packages/patches/python-3.13-fix-tests.patch		\
  %D%/packages/patches/python-anyio-unuse-exceptiongroup-in-test.patch	\
  %D%/packages/patches/python-asgi-csrf-fix-formparser.patch	\
  %D%/packages/patches/python-astropy-dont-download-iers-data.patch	\
  ...
  %D%/packages/patches/python-sphinxcontrib-httpdomain-texinfo.patch    \
  ...
  %D%/packages/patches/python-cheroot-openssl-test.patch	\
  ...
  %D%/packages/patches/python-pandarallel-fix-df-applymap.patch		\
  %D%/packages/patches/python-pandarallel-fix-parallel_apply.patch		\
  ...
  %D%/packages/patches/rpcbind-hurd.patch			\
  ...
  %D%/packages/patches/simple-cc-noexec-stack.patch		\
  %D%/packages/patches/simple-cc-path-max.patch			\
  %D%/packages/patches/simple-cc-qbebin.patch			\
  %D%/packages/patches/simple-cc-wcsrtombs.patch		\
  ...
  %D%/packages/patches/starship-test-timezone-fix.patch		\
  ...
  %D%/packages/patches/xfce4-settings-hotplug-events.patch      \
